...
class SeamlessRoutePool{
  ...
  noteCredits(route,credits){if(Number.isFinite(credits?.creditsRemaining)){route.lastCredits=credits.creditsRemaining;route.lastCreditsAt=credits.observedAt;route.lastCreditDiagnostic=credits.diagnostic||null;route.forcedExhausted=credits.creditsRemaining<=0}}
