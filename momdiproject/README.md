...
v44 adds a real authenticated **LinkedIn Direct** collector and adaptive query partitioning on top of the v43 public OSINT engine.
...
LINKEDIN_DIRECT_ALIASES_PER_ROLE=16
LINKEDIN_DIRECT_DELAY_MS=650
PROSPECT_ADAPTIVE_SPLIT_DEPTH=3
PROSPECT_MAX_ENGINE_CALLS=180
```
