...
Set `SUPABASE_URL` to your project URL, normally `https://<project-ref>.supabase.co`. The server also normalizes a value that was accidentally entered with leading `//` so it does not produce invalid URLs.
