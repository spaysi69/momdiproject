...
“Find person” uses Seamless Contact Search only. It does not call `/contacts/research` or decrement the research credit ledger. The UI has a 12-second request timeout, while provider search requests are capped at 10 seconds. Exact LinkedIn URL matching is required before a person is shown.
